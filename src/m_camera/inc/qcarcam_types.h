...
typedef enum
{
    QCARCAM_INPUT_TYPE_DRIVER        = 0,   ///< Driver monitor
    QCARCAM_INPUT_TYPE_DIGITAL_MEDIA = 1,   ///< Digital Video Recorder
    QCARCAM_INPUT_TYPE_GESTURE       = 2,
    QCARCAM_INPUT_TYPE_OCCUPANT      = 3,   ///< Occupant monitor
    QCARCAM_INPUT_TYPE_EXT_REAR      = 4,   ///< Exterior Rear
    QCARCAM_INPUT_TYPE_EXT_RIGHT     = 5,
    QCARCAM_INPUT_TYPE_EXT_FRONT     = 6,
    QCARCAM_INPUT_TYPE_EXT_LEFT      = 7,
    QCARCAM_INPUT_TYPE_REAR_VIEW     = 8,   ///< Rear View
