...
#define  __CLASS_STRING2ENUM(enumType, symbol_func_,className, strValue) inline enumType __FUNC_S(symbol_func_, enumType,,,)(const std::string& strValue)
#define __CLASS_ENUM_TO_STR(className, symbol_fun, enumType, enumValue) inline std::string __FUNC_S(symbol_fun,,,,)(enumType enumValue)

// #define  __CLASS_STRING2ENUM(enumType, symbol_func_,className, strValue) enumType __FUNC_S(symbol_func_, enumType,,,)(const std::string& strValue)
// #define __CLASS_ENUM_TO_STR(className, symbol_fun, enumType, enumValue) std::string __FUNC_S(symbol_fun,,,,)(enumType enumValue)
...
#define CLASS_STRING2ENUM(enumType) __CLASS_STRING2ENUM(enumType, string_to_, EnumCvt, strEnum)
#define CLASS_ENUM_TO_STR(enumType) __CLASS_ENUM_TO_STR(EnumCvt, enum_to_string, enumType, enumInput)
